package com.fxexperience.tools.gui.styler;
...
import com.fxexperience.tools.gui.previewpanel.PreviewPanelController;
 ...
 * @author Jasper Potts
 */
public class StylerController extends AbstractController implements Initializable {
    ...
    public StylerController(ViewHandler viewHandler) {
        super(viewHandler);
    }
