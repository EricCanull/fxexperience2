package com.fxexperience.tools.controllers.derivationcontroller;
...
public class DerivationController implements Initializable {
    ...
    @Override public void initialize(URL url, ResourceBundle rb) {
        anchorPane.getStylesheets().add(DerivationController.class.getResource("DerivationCalc.css").toString());  
