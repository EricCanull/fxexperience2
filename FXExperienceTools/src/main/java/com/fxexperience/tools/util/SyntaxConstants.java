...
public interface SyntaxConstants {
    ...
    enum BaseConstants {
        ...
        public static ObservableList<SyntaxConstants.BaseConstants> getList() {
            ObservableList<SyntaxConstants.BaseConstants> list = FXCollections.observableArrayList();
    ...
    enum RepeatOrReflect {
        ...
        public static ObservableList<SyntaxConstants.RepeatOrReflect> getList() {
            ObservableList<SyntaxConstants.RepeatOrReflect> list = FXCollections.observableArrayList();
    ...
    enum LinearDirection {
        ...
        public static ObservableList<SyntaxConstants.LinearDirection> getList() {
            ObservableList<SyntaxConstants.LinearDirection> list = FXCollections.observableArrayList();
